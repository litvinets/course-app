...
} from '@app/shared/components/authorization/registration-form/registration-form.component';
import {
  EmailConfirmationComponent
} from '@app/shared/components/authorization/login-modal/email-confirmation/email-confirmation.component';
